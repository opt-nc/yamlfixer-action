...
if [ $result -ne 0 ] ; then
  ...
  curl  --trace-ascii -v -H "Accept: application/vnd.github.v3+json" https://api.github.com/repos/opt-nc/$repository_name/pulls -d '{"head":"yamlfixer_patch","base":"'$branch_name'"}'
else
